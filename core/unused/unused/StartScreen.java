...
import com.mirre.ball.screens.CircleScreen;
...
public class StartScreen extends GameScreen {
	...
	public static BitmapFont font = new BitmapFont(Gdx.files.internal("data/font.fnt"), Gdx.files.internal("data/font.png"), false);;
	...
	public void render(float delta) {
		...
		font.drawMultiLine(batch, "Hello I want to try", 100, 300, 200, HAlignment.RIGHT);
		batch.end();
